...
(function ($) {
    $.fn.FacebookAlbumBrowser = function (options) {
        var defaults = {
            ...
            shareButton: false,
            albumsPageSize: 0,
            albumsMoreButtonText: "flere albummer...",
            photosPageSize: 0,
            photosMoreButtonText: "flere billeder...",
            checkedPhotos: []
        }
        ...
        selector.each(function (index) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (cover) {
                                            ...
                                            if (!$(cover).get(0).error && $(cover).get(0).images) {
                                                ...
                                                var albumThumb = $("<div>", { style: "background-image: url('" + albumImg.source + "');", src: "", "data-id": $(cover).get(0).id, class: "fb-album-thumb" })
                    ...
                    success: function (result) {
                        ...
                        if (result.data.length > 0) {
                            ...
                            for (a = 0; a < result.data.length; a++) {
                                ...
                                var photoThumb = $("<div>", { style: "background-image: url('" + albumImg.source + "');", src: "", "data-id": $(result.data).get(a).id, class: "fb-photo-thumb" });
            ...
            function initLightboxes(photoLink) {
                ...
                if (overlay.length == 0) {
                    ...
                    overlay.append($("<img>", { class: "fb-preview-img-prev", src: "/images/facebook/prev-icon.png" }));
                    overlay.append($("<img>", { class: "fb-preview-img-next", src: "/images/facebook/next-icon.png" }));
